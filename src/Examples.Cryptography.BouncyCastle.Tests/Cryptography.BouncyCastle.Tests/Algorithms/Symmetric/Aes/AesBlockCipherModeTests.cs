...
/// <summary>
/// Tests for 3 Symmetric Cipher Algorithms
/// </summary>
/// <seealso href="https://downloads.bouncycastle.org/csharp/docs/BC-CSharpDotNet-UserGuide.pdf"/>
public class AESBlockCipherModeTests
{
    ...
    /// </summary>
    [Fact]
    public void When_ECB_PaddedEncryptionDecryption_Then_OriginalDataIsRestored()
    {
    ...
    /// </summary>
    [Fact]
    public void When_CBC_PaddedEncryptionDecryption_Then_OriginalDataIsRestored()
    {
        var inputText = "Here is some data to encrypt!";
    ...
    /// </summary>
    [Fact]
    public void When_CFB_ByteStreamEncryptionDecryption_Then_OriginalDataIsRestored()
    {
        var inputText = "Here is some data to encrypt!";
    ...
    /// </summary>
    [Fact]
    public void When_CTR_WithoutPaddingEncryptionDecryption_Then_OriginalDataIsRestored()
    {
        var inputText = "Here is some data to encrypt!";
        byte[] iv = Random.GenerateSeed(16); // need random.
    ...
    /// </summary>
    [Fact]
    public void When_CCM_AEADWithoutPaddingEncryptionDecryption_Then_OriginalDataIsRestored()
    {
        var inputText = "Here is some data to encrypt!";
    ...
    /// </summary>
    [Fact]
    public void When_GCM_AEADEncryptionDecryption_Then_OriginalDataIsRestored()
    {
        var inputText = "Here is some data to encrypt!";
    ...
    /// <summary>
    /// Example 8 – Key and Initialization Vector Generation
    /// </summary>
    /// <param name="keySize"></param>
    /// <param name="iv"></param>
    /// <returns></returns>
