...
public class RSASignDataTests(ITestOutputHelper output)
{
    [Fact]
    public void When_Signed_Then_VerificationSucceedsWithOriginalKey()
    {
        try
        {
            ...
            using var rsa = RSA.Create(keySizeInBits: 2048 /* use 4096 or more */);
