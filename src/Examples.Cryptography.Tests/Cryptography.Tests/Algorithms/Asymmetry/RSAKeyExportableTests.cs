...
public class RSAKeyExportableTests(RSAKeyExportableTests.Fixture fixture, ITestOutputHelper output)
     : IClassFixture<RSAKeyExportableTests.Fixture>
{
    public class Fixture : IDisposable
    {
        ...
        public RSA KeyPair { get; } = RSA.Create(keySizeInBits: 2048 /* use 4096 or more */);
    }
