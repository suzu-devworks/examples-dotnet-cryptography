...
/// <summary>
/// This class is used to create a custom XmlDocument that
/// adds the 'ds' prefix to elements in the XML Digital Signature namespace,
/// except for 'SignedInfo' and its descendants.
/// </summary>
public class XmlDsigDocument : XmlDocument
{
    ...
    public override XmlElement CreateElement(string? prefix, string localName, string? namespaceURI)
    {
        ...
        if (string.IsNullOrEmpty(prefix))
        {
            ...
            var signedInfoAndDescendants = new HashSet<string>
            {
                "SignedInfo",
