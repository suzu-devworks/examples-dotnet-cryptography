...
public static class X509CertificateLoader
{
    ...
    /// <summary>
    /// Loads the certificate from an <see cref="X509CertificateStructure" />, replacement for this object.
    /// </summary>
    /// <param name="pem">The PEM text of the certificate to import.</param>
